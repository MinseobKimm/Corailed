...
class RandomAgent(Agent):
    ...
    def get_path(self, start, obj, game, last):
        ...
        if obj == "axe":
            axe = map.get_pos('A')
            return a_star.run(map, start, axe, game, last)
        elif obj == "pickaxe":
            pickaxe = map.get_pos('I')
            return a_star.run(map, start, pickaxe, game, last)
        elif obj == "tree":
            tree = map.get_pos('t')
            return a_star.run(map, start, tree, game, last)
        elif obj == "rock":
            rock = map.get_pos('k')
            return a_star.run(map, start, rock, game, last)
...
class a_star():
    def run(self, player_pos, obj, game, last):
        pass
